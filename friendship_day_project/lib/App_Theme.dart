...
class AppTheme {
  ...
  static  Color _lightPrimaryVariantColor = AppTheme.hexToColor("#352245");
  static const Color _lightSecondaryColor = Colors.grey;
  static const Color _lightOnPrimaryColor = Colors.black;
  static  Color _lightPrimaryIconThemeColor = AppTheme.hexToColor("#352245");
  static const Color _lightButtonTextColor = Colors.white;
  static const Color _lightButtonColor = Colors.yellow ;
  static   Color _lightButtonSplashColor = AppTheme.hexToColor("#352245");
